...
if(jam<5)jam=document.write('<h id="webpulsaid">Bangun Pagi itu indah, lebih indah banyak downline transaksi..</h>');
if(jam<6)jam=document.write('<h id="webpulsaid">Selamat pagi,jangan lupa mandi Bos..!!</h>');
if(jam<7)jam=document.write('<h id="webpulsaid">Selamat beraktifitas semoga uhasa hari ini lancar, Banyak downline banyak komisi.</h>');
