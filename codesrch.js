...
var uri = window.location.toString();
if (uri.indexOf("/p/harga.html","/p/harga.html") > 0) {
  var clean_uri = uri.substring(0, uri.indexOf("/p/harga.html"));
    window.history.replaceState({}, document.title, clean_uri);
}
var uri = window.location.toString();
if (uri.indexOf("/p/webreport.html","/p/webreport.html") > 0) {
  var clean_uri = uri.substring(0, uri.indexOf("/p/webreport.html"));
    window.history.replaceState({}, document.title, clean_uri);
}
var uri = window.location.toString();
if (uri.indexOf("/p/cetak-struktur.html","/p/cetak-struktur.html") > 0) {
  var clean_uri = uri.substring(0, uri.indexOf("/p/cetak-struktur.html"));
    window.history.replaceState({}, document.title, clean_uri);
}
